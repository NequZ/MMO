...
{
    void Start_Example() {}
    void OnStartClient_Example() {}
    void OnStartServer_Example() {}
    void OnStopServer_Example() {}
    void OnClientConnect_Example(NetworkConnection conn) {} // after successful login
    void OnServerConnect_Example(NetworkConnection conn) {} // after successful login
    ...
    void OnServerCharacterSelect_Example(string account, GameObject player, NetworkConnection conn, CharacterSelectMsg message) {}
