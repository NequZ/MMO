...
public partial class NetworkManagerMMO : NetworkManager
{
    ...
    public void OnServerCharacterSelect(NetworkConnection conn, CharacterSelectMsg message)
    {
...
#pragma warning disable CS0618 // AddPlayerMessage.value is obsolete
                Utils.InvokeMany(typeof(NetworkManagerMMO), this, "OnServerAddPlayer_", account, go, conn, new AddPlayerMessage{ value=BitConverter.GetBytes(message.value) }); // old hook
